...
public class InlineFilterIntoMap extends MasterBenchmarkFilterMap{
    public static void main(String[] args) {
        InlineFilterIntoMap ifm = new InlineFilterIntoMap();
                ...
                Step aux1 = ((Function<Object, Step>) x2 -> {
                    ...
                    if (lAux.isEmpty()) {
                        ...
                        if (((Predicate) p).test(lAux.get(0))) {
                            return new Yield<>((Student) lAux.get(0), sub);
                        } else {
                            return new Skip<>(sub);
                        }
                    }
