...
public class InlineTakeIntoUnfold extends MasterBenchmarkUnstreamIterate{
    public static void main(String[] args) {
        System.out.println(MethodHandles.lookup().lookupClass().getSimpleName() + "...");

        InlineTakeIntoUnfold itiu = new InlineTakeIntoUnfold();
        ...
        while (!over) {
            Step step = ((Function<Object, Step>) x -> {
                ...
                if (p.getX() == 0) {
                    ...
                    return new Yield<>(p.getY(), new Pair<>(p.getX() - 1, f1.apply((List<BigInteger>) p.getY())));
                }
