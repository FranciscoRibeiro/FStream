...
public class TrivialRewriteInIterateFunction extends MasterBenchmarkUnstreamIterate{
    public static void main(String[] args) {
        System.out.println(MethodHandles.lookup().lookupClass().getSimpleName() + "...");

        TrivialRewriteInIterateFunction triif = new TrivialRewriteInIterateFunction();
