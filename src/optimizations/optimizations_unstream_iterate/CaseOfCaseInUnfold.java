...
public class CaseOfCaseInUnfold extends MasterBenchmarkUnstreamIterate{
            ...
            Step step = ((Function<Object, Step>) x -> {
                ...
                if (p.getX() == 0) {
                    ...
                    if (innerAux instanceof Done) {
                        ...
                        res.add((List<BigInteger>) innerAux.elem);
                        auxState[0] = innerAux.state;
                    }
                } else {
                    Step innerAux = new Yield<>(p.getY(), new Pair<>(p.getX() - 1, f1.apply((List<BigInteger>) p.getY())));
