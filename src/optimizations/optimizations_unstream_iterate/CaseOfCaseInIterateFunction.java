                                        ...
                                        if (x11 instanceof Left) {
                                            Step aux2 = ((Function<Object, Step>) x2 -> {
                                                ...
                                                if (lAux.isEmpty()) {
                                                    ...
                                                    List<Integer> sub = lAux.subList(1, lAux.size());
                                                    Step innerAux = new Yield<>(((Function<Pair<Integer, Integer>, Integer>) p -> p.getX() + p.getY()).apply(new Pair<>((Integer) ((Triple) x1).getElem().get(), (Integer) lAux.get(0))), new Triple(((Triple) x1).getStateA(), new Left(sub), Optional.empty()));
                                            ...
                                            Step aux2 = ((Function<Object, Step>) x2 -> {
                                                ...
                                                if (lAux.isEmpty()) {
                                                    ...
                                                    List<Integer> sub = lAux.subList(1, lAux.size());
                                                    Step innerAux = new Yield<>(((Function<Pair<Integer, Integer>, Integer>) p -> p.getX() + p.getY()).apply(new Pair<>((Integer) ((Triple) x1).getElem().get(), (Integer) lAux.get(0))), new Triple(((Triple) x1).getStateA(), new Right(sub), Optional.empty()));
